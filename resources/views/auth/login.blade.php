                    ...
                    <div class="card-body">
                        <div class="px-3">
                            ...
                            <div class="text-center auth-logo-text">
                                <h4 class="mt-0 mb-3 mt-5">Sign in to your account!</h4>
                                <p class="text-muted mb-0">Enter your credentials to access the system.</p>
                            </div> <!--end auth-logo-text-->
                            <form class="form-horizontal auth-form my-4" action="{{ route('login.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group row mt-4">
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-switch switch-success">
                                            ...
                                            <label class="custom-control-label text-muted" for="customSwitchSuccess">Keep me signed in</label>
                                        </div>
                                    </div><!--end col-->
                                ...
                                <div class="form-group mb-0 row">
                                    <div class="col-12 mt-2">
                                        <button class="btn btn-gradient-primary btn-round btn-block waves-effect waves-light" type="submit">Sign In <i class="fas fa-sign-in-alt ml-1"></i></button>
                                    </div><!--end col-->
                                </div> <!--end form-group-->
                            </form><!--end form-->
                        </div><!--end /div-->
