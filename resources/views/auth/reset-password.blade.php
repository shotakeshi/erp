                ...
                <div class="card auth-card shadow-lg">
                    <div class="card-body">
                        <div class="px-3">
                            ...
                            <form class="form-horizontal auth-form my-4" action="{{ route('password.update', $token) }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <span class="auth-form-icon">
                                            <i data-feather="email" class="icon-xs"></i>
                                        </span>
                                        <input type="text" readonly class="form-control" id="email" name="email" value="{{ old('email', $email) }}">
                                    </div>
                                </div><!--end form-group-->
                                <div class="form-group">
                                ...
                                <div class="form-group mb-0 row">
                                    <div class="col-12 mt-2">
                                        <button class="btn btn-gradient-primary btn-round btn-block waves-effect waves-light" type="submit">{{ __('common.account.reset_password_confirm') }}</button>
                                    </div><!--end col-->
                                </div> <!--end form-group-->
                            </form><!--end form-->
                        </div><!--end /div-->
